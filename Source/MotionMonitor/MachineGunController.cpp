...
{
// 	++m_fps;
// 	m_lastFPSUpdateTime += deltaSeconds;
// 	if (m_lastFPSUpdateTime >= 1.f)
// 	{
// 		dbg::Print("fps = %d\n", m_fps);
// 
// 		m_lastFPSUpdateTime = 0;
...
// 	}
	...
	{
// 		++m_camFPS;
// 		m_lastCamUpdateTime += deltaSeconds;
// 		if (m_lastCamUpdateTime >= 1.f)
// 		{
// 			dbg::Print("camera fps = %d\n", m_camFPS);
// 
// 			m_lastCamUpdateTime = 0;
// 			m_camFPS = 0;
// 		}
