...
BOOL CMotionMonitorApp::InitInstance()
{
	...
	config.ReadConfigFile("../media/dirt3/motionmonitor_dirt3_ex_release.json");
...
// 		wr.bottom = wr.top + 400;
	...
	{
		//m_pMainWnd->SetWindowTextW(L"Dirt3 Manager  v1.0");

		// fan speed control bug fix
		m_pMainWnd->SetWindowTextW(L"Dirt3 Manager  v1.01");
	}
	else if (config.m_mode == "realshot")
	{
