...
{
	SendMotionControllSwitchMessage(VITCON_SER::START);
}
void CMotionOutputView::OnBnClickedButtonStop()
{
	SendMotionControllSwitchMessage(VITCON_SER::STOP);
}
void CMotionOutputView::OnBnClickedButtonOrigin()
{
	SendMotionControllSwitchMessage(VITCON_SER::ORIGIN);
}
void CMotionOutputView::OnBnClickedButtonEmergency()
{
	SendMotionControllSwitchMessage(VITCON_SER::EMERGENCY);
}
void CMotionOutputView::OnBnClickedButtonServoOn()
{
	SendMotionControllSwitchMessage(VITCON_SER::SERVOON);
}
void CMotionOutputView::OnBnClickedButtonServoOff()
{
	SendMotionControllSwitchMessage(VITCON_SER::SERVOOFF);
}
